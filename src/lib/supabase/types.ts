 ...
 *
 * This file is manually maintained until a live Supabase project is
 * connected. Once connected, regenerate via:
 *   npm run db:generate-types
 *
 * SCHEMA ALIGNMENT: Verified against migrations 001-015 on 2026-02-10.
 */
  ...
  public: {
    Tables: {
      ...
      gig_listings: {
        ...
        Relationships: [
          {
            foreignKeyName: "gig_listings_platform_id_fkey"
            columns: ["platform_id"]
            referencedRelation: "platforms"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "gig_listings_pillar_id_fkey"
            columns: ["pillar_id"]
            referencedRelation: "service_pillars"
            referencedColumns: ["id"]
          },
        ]
      }
      gig_versions: {
        ...
        Relationships: [
          {
            foreignKeyName: "gig_versions_gig_id_fkey"
            columns: ["gig_id"]
      ...
      opportunities: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "opportunities_pillar_id_fkey"
            columns: ["pillar_id"]
            referencedRelation: "service_pillars"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "fk_opportunities_proposal_template"
      ...
      proposal_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: "proposal_templates_pillar_id_fkey"
            columns: ["pillar_id"]
            referencedRelation: "service_pillars"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "proposal_templates_platform_id_fkey"
            columns: ["platform_id"]
            referencedRelation: "platforms"
            referencedColumns: ["id"]
          },
      ...
      portfolio_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "portfolio_items_pillar_id_fkey"
            columns: ["pillar_id"]
            referencedRelation: "service_pillars"
            referencedColumns: ["id"]
          },
      ...
      revenue_entries: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "revenue_entries_platform_id_fkey"
            columns: ["platform_id"]
            referencedRelation: "platforms"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "revenue_entries_pillar_id_fkey"
            columns: ["pillar_id"]
            referencedRelation: "service_pillars"
            referencedColumns: ["id"]
          },
      ...
      daily_metrics: {
        ...
        Relationships: [
          {
            foreignKeyName: "daily_metrics_platform_id_fkey"
            columns: ["platform_id"]
            referencedRelation: "platforms"
            referencedColumns: ["id"]
          },
