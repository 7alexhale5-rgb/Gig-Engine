# Legacy SaaS Scaffold Specification

> Reference only — this documents the original Next.js SaaS application design that was abandoned in favor of the document-driven deployment system. The active system is documented in `../CLAUDE.md`.
